...
<div class="py-5">
    ...
    <DIV class='container'> 
        ...
        <ASIDE class="aside_right">
          ...
          <span class='menu_divide' >　</span>
          <A href="./list_by_commgrpno_grid_paging.do?commgrpno=${param.commgrpno }&now_page="><IMG style="width:24px;"src='/css/images/photo_gray.png'></A>        
        </ASIDE>
            ...
            <DIV style='width: 19%; height: 290px; float: left; margin-top:5px; margin-bottom: 23px; margin-left: 10px;  padding: 0.2%; 
              ...
              <c:choose>
                <c:when test="${bsize > 0}"> <!-- 파일이 존재하면 -->
                  <c:choose> 
                    ...
                    <c:when test="${thumb.endsWith('jpg') || thumb.endsWith('png') || thumb.endsWith('gif')}"> <!-- 이미지 인경우 -->
                      <div onclick="./read.do?boardno=${boardno}&word=${param.word }&now_page=${param.now_page}">               
                ...
                <c:otherwise> <%-- 파일이 없는 경우 기본 이미지 출력 --%>
                  <div>
                    <a href="./read.do?boardno=${boardno}&word=${param.word }&now_page=${param.now_page}">
