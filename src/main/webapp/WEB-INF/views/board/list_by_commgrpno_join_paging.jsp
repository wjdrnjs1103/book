        ...
        <TABLE class='table table_top_margin'>
          ...
          <tbody  style="font-size: 1.08em;">
            <c:forEach var="commgrp_boardVO" items="${list}">
              ...
              <c:set var="boardno" value="${commgrp_boardVO.boardno }" />
              <c:set var="title" value="${commgrp_boardVO.title }" />
              <c:set var="bcon" value="${commgrp_boardVO.bcon }" />
              <c:set var="word" value="${commgrp_boardVO.word }" />
              <c:set var="bcnt" value="${commgrp_boardVO.bcnt }" />
              <c:set var="writer" value="${commgrp_boardVO.writer }" />
              <c:set var="brdate" value="${commgrp_boardVO.brdate }" />
