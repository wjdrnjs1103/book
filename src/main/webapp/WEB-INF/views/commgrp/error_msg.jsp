...
<DIV class='title_line'>커뮤니티 알림</DIV>
    ...
    <UL>
      <c:choose>
        <c:when test="${code == 'create'}"> <%-- Java if --%>
          <LI class='li_none'>
            <span class="span_success">새로운 커뮤니티 그룹 [${categrpVO.name }] 등록에 실패했습니다.</span>
          </LI>                                                                      
        </c:when>
        <c:when test="${code == 'update'}"> <%-- Java if --%>
          <LI class='li_none'>
            <span class="span_success">카테고리 커뮤니티 수정에 실패했습니다.</span>
          </LI>                                                                      
        </c:when>
        <c:when test="${code == 'delete'}"> <%-- Java if --%>
          <LI class='li_none'>
            <span class="span_success">카테고리 커뮤니티 삭제에 실패했습니다.</span>
          </LI>                                                                      
        </c:when>        
        <c:otherwise>
