    ...
    <UL>
      ...
      <LI class='li_none'>
        ...
        <c:choose>
          <c:when test="${param.cnt == 1 }">
            <button type='button' 
                         onclick="location.href='./create.do?productno=${param.productno}'"
                         class="btn btn-dark">새로운 리뷰 등록</button>
          </c:when>
          <c:otherwise>
        ...
        <button type='button' onclick="location.href='./list_by_productno.do?productno=${param.productno}'" class="btn btn-dark">목록</button>
      </LI>
    </UL>
  </fieldset>
