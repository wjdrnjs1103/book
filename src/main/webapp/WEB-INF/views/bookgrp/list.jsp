...
<div class="py-5">
     ...
     <DIV class='container c_bottom_10' style=""> 
        <DIV class='title_line'>
          <a href="./list.do" class='title_link'>전공도서</a>
        </DIV>         
        ...
        <TABLE class='table table_top_margin'>
          ...
          <c:forEach var="bookgrpVO" items="${list}">
            ...
            <TR style="height: 50px;">
              <TD class="td_bs" style="padding-top: 12px;">${bookgrpVO.seqno }</TD>
              <TD class="td_bs_left" style="font-weight: bold; padding-top: 12px;">
                  <A href="../book/list_member.do?bookgrpno=${bookgrpno }">${bookgrpVO.name }</A>
              </TD>
              <TD class="td_bs" style="padding-top: 12px;">${bookgrpVO.rdate.substring(0, 10) }</TD>
