...
<DIV class="py-5">
 ...
 <DIV class='container2'> 
  <DIV class='title_line'>전공도서 그룹 > ${bookgrpVO.name } 조회(수정)</DIV>

<DIV class='content_body'>
  <DIV id='panel_create' style='padding: 10px 0px 10px 0px; background-color: #F9F9F9; width: 100%; text-align: center;'>
    <FORM name='frm_update' id='frm_update' method='POST' action='./update.do'>
      <input type='hidden' name='bookgrpno' id='bookgrpno' value='${bookgrpVO.bookgrpno }'>
        
      <label>그룹 이름</label>
      <input type='text' name='name' value="${bookgrpVO.name }" required="required" 
                 autofocus="autofocus" style='width: 25%;'>
 
      <label>순서</label>
      <input type='number' name='seqno' value="${bookgrpVO.seqno }" required="required" 
