...
public class AES256Util {
   ...
   * 
   * String text = "가나다 123 ABC !@#"; // String text = "123"; //
   * spyryuhFvhnnv6cD2ROB8g== System.out.println("암호화할 문자 : " + text);
   * 
   ...
   * 
   * System.out.println("새로운 문자열 다시 암호화"); String text2 = "가나다 123 ABC !@#";
   * String encText2 = aes256.aesEncode(text); // 암호화
   * System.out.println("암호화된 문자(DBMS 저장) : " + encText);
   * 
   * //비교시 복호화가 아니라 암호화를하여 비교 if(encText.equals(encText2)) {
   * System.out.println("암호화를 하여 비교했으며 동일한 패스워드임"); }
   * 
   * }
   */
